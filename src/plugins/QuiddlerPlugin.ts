...
CARD DESIGN: Each Quiddler card shows a letter (A-Z) or double-letter (TH, QU, IN, ER, CL) in an ornate Celtic style in the center. The letter also appears in SMALL PRINT in the TOP-LEFT and BOTTOM-RIGHT corners, along with a small point value number.
